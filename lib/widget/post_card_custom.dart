...
class PostDetailCard extends StatelessWidget {
  ...
  const PostDetailCard({super.key, required this.data, this.isLoading = false});
        ...
        children: [
          ...
          SingleChildScrollView(
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  Text('Post ID : ${data.orderId}', style: AppTextStyle.title(fontWeight: FontWeight.bold)),
                  SizedBox(width: 15.w),
          ...
          Divider(thickness: 2.0, color: AppColors.appMutedColor, height: 1.0),
          SizedBox(height: 15.h),
