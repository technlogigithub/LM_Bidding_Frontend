                    ...
                    children: [
                      ...
                      Expanded(
                        child: StepProgressIndicator(
                          ...
                          unselectedColor: AppColors.appColor.withOpacity(0.2),
                        ...
                        child: Stack(
                          ...
                          children: [
                            Container(
                              ...
                              child: Icon(IconlyBold.profile, color: AppColors.kBorderColorTextField, size: 68),
                            ),
                            GestureDetector(
                              onTap: () {
                        ...
                        builder: (FormFieldState<dynamic> field) {
                          return InputDecorator(
                            decoration: InputDecoration(
                              ...
                              labelStyle: kTextStyle.copyWith(color: AppColors.neutralColor, fontWeight: FontWeight.bold),
                            ),
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          children: [
                            ...
                            const Spacer(),
                            Icon(FeatherIcons.plusCircle, color: AppColors.subTitleColor, size: 18.0),
...
class InfoShowCaseWithoutIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: context.width(),
      padding: const EdgeInsets.all(10.0),
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(8.0), color: AppColors.appWhite, border: Border.all(color: AppColors.kBorderColorTextField)),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(
