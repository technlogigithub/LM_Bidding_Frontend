...
import 'package:libdding/widget/custom_view_widget.dart';
          ...
          child: SingleChildScrollView(
            ...
            child: Center(
              child: ConstrainedBox(
                constraints: const BoxConstraints(maxWidth: 1200), // Max width for web dashboard feel
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SizedBox(height: screenHeight * 0.010),
                    Padding(
                      padding: EdgeInsets.symmetric(horizontal: isWeb ? 0 : 0),
                      child: CustomTabBar(
                        // height: 50,
                        tabs: tabs,
                        initialIndex: 0,
                    ...
                    Obx(() {
                      ...
                      return CustomViewWidget(
                        type: widget.menuItem?.nextPageViewType ?? "",
                        controller: controller,
                        itemDataList: controller.currentList,
                        onItemTap: (id) {
                          final item = controller.currentList.firstWhereOrNull((e) => e.hidden?.ukey == id);
                          if (item != null && item.hidden?.nextPageName != null && item.hidden?.nextPageApiEndpoint != null) {
                            Get.to(() => const ParticipateDetailsScreen(), arguments: item.hidden!.nextPageApiEndpoint);
                          }
                        },
                      );
                    }),
