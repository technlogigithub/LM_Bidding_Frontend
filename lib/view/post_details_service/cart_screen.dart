          ...
          child: ButtonGlobalWithoutIcon(
            ...
            onPressed: () async {
              if (submitButton.apiEndpoint?.isNotEmpty == true) {
                ...
                String userKey = ""; // You might want to get this from prefs if not available elsewhere, usually handled in controller but for form construction we can pass it or let controller handle it.
                // Note: Controller's submitCart handles headers and auth, but typically user_key is part of body in this app structure. 
                // Let's get it from prefs for consistency if needed in body.
            ...
            if (!hasNextPage && !hasNextApi && !hasNextView && hasConfirmData) {
              ...
              var result = await showModalBottomSheet(
                ...
                builder: (context) => Padding(
                  ...
                  child: BidBottomSheet(title: title, description: description, pageImage: pageImage, design: design == null ? null : CartItemActionDesign.fromJson(design), apiEndpoint: apiEndpoint),
                ),
              );
