  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      top: false,
        child: Scaffold(
          appBar: AppBar(
            title: Text(AppStrings.cartScreen,style: AppTextStyle.title(color: AppColors.appTextColor)),
            centerTitle: true,
            ...
            child: SingleChildScrollView(
              ...
              child:Column(
                children: [
                  ...
                  // CustomVerticalListviewList( onFavoriteToggle: controller.toggleFavorite, isLoading: controller.isLoading,isFromCartScreen: true,),
