            ...
            child: Column(
              ...
              children: [
                ...
                Builder(builder: (context) {
                  // Use menuItem instead of appSettingController.myOrderModel
                  final SettingsDesign? design = (menuItem?.design != null && menuItem!.design is Map)
                      ? SettingsDesign.fromJson(menuItem!.design)
                      : (menuItem?.design is SettingsDesign ? menuItem!.design : null);
