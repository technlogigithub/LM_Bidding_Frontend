  ...
  Widget _buildFormContentWithPageView(
    ...
    return Builder(
      builder: (context) {
        ...
        // Calculate available height dynamically accounting for keyboard
        final viewportHeight = screenSize.height - padding.top - padding.bottom;

        // Calculate space needed for other UI elements
        // AppBar: 80, Progress bar area: ~60, Description: ~40, Bottom buttons: ~80, Padding: 32
        final otherUIHeight = 80.0 + 60.0 + 40.0 + 80.0 + 32.0;

        // Available height = viewport - other UI - keyboard
        final availableHeight = viewportHeight - otherUIHeight - keyboardHeight;

        // Ensure minimum height for proper rendering
        final height = (availableHeight > 300 ? availableHeight : 300.0);
